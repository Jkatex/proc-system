        ...
        <div class="app-container">
            <div style="max-width: 800px; margin: 80px auto; text-align: center;">
                ...
                <div class="role-cards">
                    <div class="role-card" data-navigate="iam-verification" data-role="buyer">
                    ...
                    <div class="role-card" data-navigate="iam-verification" data-role="supplier">
                        <svg class="role-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="role-card" data-navigate="iam-verification" data-role="admin">
                        <svg class="role-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p>Manage users, monitor system health, and oversee platform operations</p>
                    </div>
                </div>
