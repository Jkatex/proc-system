    ...
    communicationCenter: {
        ...
        items: [
            ...
            },
            {
                ...
                body: 'Please confirm the preferred site access window for the maternal health wing pre-mobilization inspection.',
                ...
                actionRequired: false,
                visibility: 'Private',
                createdAt: '2026-05-16T08:15:00',
                updatedAt: '2026-05-16T08:15:00',
                audience: ['user']
            },
            {
                id: 'report-001',
                ...
                subject: 'Monthly implementation report submitted',
                ...
                actionPage: 'records-history',
                visibility: 'Private',
                attachments: [
                    { id: 'att-report-001', name: 'May-implementation-report.pdf', fileType: 'pdf' },
                    { id: 'att-report-002', name: 'Risk-register-update.xlsx', fileType: 'spreadsheet' }
                ],
                createdAt: '2026-05-16T09:45:00',
                updatedAt: '2026-05-16T09:45:00',
                audience: ['user']
            },
            {
                id: 'clar-answered-001',
                kind: 'clarification',
                folder: 'inbox',
                category: 'Technical Specification',
                subject: 'Response to HVAC specification question',
                body: 'The HVAC specification should be read together with Addendum 2. The minimum efficiency requirement remains unchanged.',
                ...
                thread: [
                    { senderType: 'Supplier', senderName: 'Kilimanjaro Supplies Limited', body: 'Please confirm the required HVAC efficiency rating.', createdAt: '2026-05-14T09:20:00' },
                    { senderType: 'Buyer', senderName: 'Ministry of Health', body: 'The minimum efficiency requirement remains unchanged and is clarified in Addendum 2.', createdAt: '2026-05-16T10:05:00' }
                ],
                createdAt: '2026-05-16T10:05:00',
                updatedAt: '2026-05-16T10:05:00',
                audience: ['user']
            },
            {
                id: 'alert-003',
                ...
                body: 'The uploaded bid form appears unsigned. Upload a signed version before the closing deadline.',
                senderId: 'system',
                senderType: 'System',
                senderName: 'ProcureX System',
                recipientId: 'user-001',
            ...
            },
            {
                ...
                visibility: 'Private',
                attachments: [
                    { id: 'att-sent-report-001', name: 'Inception-report.pdf', fileType: 'pdf' },
                    { id: 'att-sent-report-002', name: 'Workplan.xlsx', fileType: 'spreadsheet' }
                ],
                createdAt: '2026-05-16T12:20:00',
                updatedAt: '2026-05-16T12:20:00',
                audience: ['user']
            },
            {
                id: 'sent-002',
                ...
                actionRequired: false,
                visibility: 'Private',
                createdAt: '2026-05-16T13:10:00',
                updatedAt: '2026-05-16T13:10:00',
                audience: ['user']
            },
            {
                id: 'archived-001',
            ...
            },
            {
                ...
                tenderTitle: 'University Catering Services Framework',
                priority: 'Low',
                status: 'Deleted',
                read: true,
                visibility: 'Private',
                createdAt: '2026-05-12T15:35:00',
                updatedAt: '2026-05-16T14:05:00',
                audience: ['user']
            }
        ]
    },
