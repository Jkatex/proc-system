...
export function DashboardCommandCenter() {
  ...
  const pipeline = [
    { stage: 'Draft', count: 2, nav: '/procurement/create-tender' },
    ...
    { stage: 'Evaluation', count: tenders.filter((tender) => tender.status === 'EVALUATION').length + 1, nav: '/evaluation' },
    { stage: 'Award', count: 3, nav: '/awards-contracts' },
    { stage: 'Contract', count: 2, nav: '/awards-contracts/negotiation' },
    { stage: 'Completed', count: 4, nav: '/records' }
  ];
